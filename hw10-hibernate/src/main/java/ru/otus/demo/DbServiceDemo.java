...
///
        ...
        phones.clear();
        phones.add( new Phone("123456789", clientFirst) );
        dbServiceClient.saveClient( clientFirstSelected );

        log.info("All clients");
        dbServiceClient.findAll().forEach(client -> log.info("clientFirst:{}", client));
